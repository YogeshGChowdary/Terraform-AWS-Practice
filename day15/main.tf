...
resource "aws_vpc_peering_connection" "primary_to_secondary" {
  provider = aws.primary
  vpc_id = aws_vpc.primary_vpc.id   // source vpc_id
  peer_vpc_id   = aws_vpc.secondary_vpc.id   // destination vpc_id
  peer_region = var.secondary_region   // destination vpc region
  auto_accept   = false
